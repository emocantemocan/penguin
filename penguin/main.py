            ...
            while True:
                with ThreadPoolExecutor() as executor:
                    futures = [
                        ...
                        executor.submit(send_sms.Yuffi),   # Virgül eklendi
                        executor.submit(send_sms.Papara),  # Virgül eklendi
                        executor.submit(send_sms.İninal),   # Virgül eklendi
                        executor.submit(send_sms.ParolaPara),  # Virgül eklendi
                        executor.submit(send_sms.Keyubu)   # Son elemandan sonra virgül yok
                        # eklenecekler
